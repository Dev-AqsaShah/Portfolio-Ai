...
const projects = [
  ...
  },
  {
    ...
    type: "AI",
    featured: false,
    title: "AI Todo App with Claude Chatbot",
    short: "Task Manager + Anthropic AI Chat",
    desc: "Full-stack multi-phase project featuring a smart todo & task management system paired with an Anthropic Claude-powered chatbot. Built progressively — Phase 1 (Python CLI), up to Phase V (Next.js dashboard, auth, real-time chat, notifications, scheduler). Microservices architecture with Docker Compose & Kubernetes.",
