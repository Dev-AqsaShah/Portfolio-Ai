...
export default function ProjectsPage() {
  const projects = [
    ...
    },
    {
      ...
      link: "https://aqsaportfolio-chi.vercel.app/",
      images: [
        "/assets/aiport1.png",
        "/assets/aiport2.png",
        "/assets/aiport3.png",
  ...
  return (
    <main className="relative min-h-screen">
      ...
      {/* Image Slider Overlay without animation for mobile */}
      {activeImages && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex flex-col justify-center items-center z-50 p-4">
          ...
          <div className="relative w-full max-w-full sm:max-w-3xl flex justify-center items-center">
            <Image
              src={activeImages[currentIndex]}
              alt="Project"
              width={1200}
              height={800}
              className="w-full h-auto max-h-[80vh] sm:max-h-[90vh] rounded-lg object-contain"
              priority
            />
            <button
              className="absolute top-1/2 left-2 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-lg sm:p-3"
              onClick={prevImage}
            >
              <FaArrowLeft />
            </button>
            <button
              className="absolute top-1/2 right-2 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-lg sm:p-3"
              onClick={nextImage}
            >
              <FaArrowRight />
            </button>
